<%@ Page Language="C#" AutoEventWireup="true" CodeFile="understandnspeak.aspx.cs" Inherits="turkish.speaknlearn.com_understandnspeak" %>
   ...
   <form id="form2" runat="server" autocomplete="off" defaultbutton="ImageButton2">
        <div class="auto-style8">
            ...
            <div class="auto-style19">
                ...
                <asp:Image ID="Image1" runat="server" ImageUrl="~/turkish.speaknlearn.com/images/header-tr.png" Height="154px" Width="811px" />
                <br />
                <br />
...
&nbsp;<asp:TextBox ID="TextBox1" runat="server" Height="64px" Width="380px" placeholder="Press the Mic Button and Read the text above in German" BorderColor="#0000CC" BorderStyle="Double"></asp:TextBox>
        ...
        <asp:Image ID="micimage" runat="server" onclick="startDictation1()" src="images/mic.png" height="50" width="50" style="vertical-align: middle" /><br /><br />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:ImageButton ID="ImageButton2" runat="server" Height="63px" ImageUrl="~/turkish.speaknlearn.com/images/submit2.png" Width="172px" OnClick="Check_Click" CssClass="auto-style7" />
                                       
                &nbsp;&nbsp;&nbsp; &nbsp;
                    <asp:ImageButton ID="ImageButton1" runat="server" Height="63px" ImageUrl="~/turkish.speaknlearn.com/images/next.png" Width="172px" OnClick="Next_Click" CssClass="auto-style7" />
