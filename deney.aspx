<%@ Page Language="C#" AutoEventWireup="true" CodeFile="deney.aspx.cs" Inherits="deney" %>
...
<body style="background-color: #edffed">
    <form id="form2" runat="server" autocomplete="on">
        ...
        <table class="auto-style6" style="border: medium double #000080">
            ...
            <tr>
                <td class="auto-style15" style="background-color: #CCFFFF"><br /><br /><br /><br />
...
&nbsp;<asp:TextBox ID="TextBox1" runat="server" Height="64px" Width="380px" placeholder="Press the Mic Button and Read the text above in Turkish" BorderColor="#0000CC" BorderStyle="Double"></asp:TextBox>
                        &nbsp;
        <asp:Image ID="micimage" runat="server" onclick="startDictation1()" src="images/mic.png" height="50" width="50" style="vertical-align: middle" /><br /><br />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:ImageButton ID="ImageButton2" runat="server" Height="63px" ImageUrl="~/images/submit2.png" Width="172px" OnClick="ImageButton2_Click" CssClass="auto-style7" />
                                       
                &nbsp;&nbsp;
                    <asp:ImageButton ID="ImageButton1" runat="server" Height="63px" ImageUrl="~/images/next.png" Width="172px" OnClick="ImageButton1_Click" CssClass="auto-style7" />
            ...
            addEvent(window, "load", function (e) {
                addEvent(document, "mouseleave", function (e) {
                    ...
                    if (!from || from.nodeName == "HTML") {
                        ...
                        setTimeout((document.getElementById('TextBox1').value=""), 9000);
                    }
                });
            });
        </script>
