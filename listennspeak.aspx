<%@ Page Language="C#" AutoEventWireup="true" CodeFile="listennspeak.aspx.cs" Inherits="listennspeak" %>
        ...
        <table class="auto-style6" style="border: medium double #000080">
            ...
            <tr><center>
                <td class="auto-style15" style="background-color: #CCFFFF">
                    ...
                    <br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; <asp:ImageButton ID="ImageButton3" runat="server" Height="50px" ImageUrl="~/images/play.png" OnClick="ImageButton1_Click" Width="50px" style="vertical-align: middle" ImageAlign="Middle" />
        &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
        <asp:Image ID="micimage" runat="server" onclick="startDictation1()" src="images/mic.png" height="50px" width="50px" style="vertical-align: middle" ImageAlign="Middle" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:DropDownList ID="DropDownList1" runat="server" Height="35px" Width="78px">
                        <asp:ListItem Value="0.1">too slow</asp:ListItem>
                        <asp:ListItem Value="0.2">very slow</asp:ListItem>
                        <asp:ListItem Value="0.3">slow</asp:ListItem>
                        <asp:ListItem Value="0.4">less normal</asp:ListItem>
                        <asp:ListItem Selected="True" Value="0.5">normal</asp:ListItem>
                    </asp:DropDownList>
                        <br /> 
                    <br />
